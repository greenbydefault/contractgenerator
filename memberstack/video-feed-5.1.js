...
class VideoFeedApp {
  ...
  async getVideosFromUserFeed(user) {
    ...
    console.log(`📋 Video-Feed: ${videoIds.length} Video-IDs im User-Feed gefunden:`, videoIds);
    ...
    try {
      // Falls weniger als 10 IDs, einzeln laden - ansonsten via Filter mit IN-Operator
